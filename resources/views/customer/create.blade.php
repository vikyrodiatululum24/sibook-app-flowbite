<x-app-layout>
    <x-slot name="header">
        <div class="flex max-w-lg justify-center items-center mx-auto">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight dark:text-white">Tambah Customer</h2>
        </div>
    </x-slot>

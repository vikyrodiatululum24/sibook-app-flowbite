    ...
    <x-slot name="header">
        <div class="sm:flex justify-between items-center">
            <h2 class="font-semibold text-xl mb-4 text-gray-800 leading-tight dark:text-white">
                {{ __('Daftar Return Buku') }}
            </h2>
            <div class="flex gap-4 items-center ml-auto">
                <a href="{{ route('return.scan') }}"
    ...
    <div class="p-4 sm:ml-64">
        <div class="overflow-x-auto">
            <table id="search-table" class="min-w-full bg-white dark:bg-gray-800 rounded shadow">
                <thead>
                    <tr>
                        <th><span class="flex items-center">Buku</span></th>
                        <th><span class="flex items-center">Customer</span></th>
                        <th><span class="flex items-center">Tanggal Return</span></th>
                        <th><span class="flex items-center">Jumlah</span></th>
                        <th><span class="flex items-center">Keterangan</span></th>
                ...
                <tbody>
                    @foreach ($returns as $return)
                        <tr>
                            ...
                            <td class="flex gap-2">
                                <a href="{{ route('return.show', $return->id) }}" class="text-blue-600"
                                    title="Lihat">
                                ...
                                <a href="{{ route('return.edit', $return->id) }}" class="text-yellow-600"
                                    title="Edit">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
